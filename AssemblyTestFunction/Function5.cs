...
{
    public class Function5 : IFunctionInvocationFilter
    {
        ...
        public Function5(IValidateService validateService, ILoggerFactory loggerFactory)
        { 
            ...
            ILogger log)
        {
            ...
            string responseMessage = string.IsNullOrEmpty(phone)
                ? "This HTTP triggered function5 executed successfully. Pass a name in the query string or in the request body for a personalized response."
                : $"This HTTP triggered function5 executed successfully. Is Phone Valid: {isValid}";
